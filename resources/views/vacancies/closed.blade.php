        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center mb-3">
                    <h4 class="mb-0"><i class="fas fa-archive me-2"></i>Vagas Encerradas e Pausadas</h4>
                    @if($canCreate)
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-secondary text-white">
                        <h5 class="mb-0"><i class="fas fa-list me-2"></i>Listagem de Vagas Encerradas e Pausadas</h5>
                    </div>
                <div class="card-body">
                    @if(session('success'))
...
<script>
    ...
    $(document).ready(function() {
        vacanciesTable = $('#vacanciesTable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('vacancies.closed.data') }}",
                type: "GET",
