                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Editar Vaga</h4>
                ...
                <div class="col-12 mt-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <form action="{{ route('vacancies.update', $vacancy->vacancy_id) }}" method="POST" id="vacancyForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('vacancy_title') is-invalid @enderror" 
                                               ...
                                               value="{{ old('vacancy_title', $vacancy->vacancy_title) }}" 
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('vacancy_description') is-invalid @enderror" 
                                                  ...
                                                  required>{{ old('vacancy_description', $vacancy->vacancy_description) }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('urgency_level') is-invalid @enderror" 
                                            ...
                                            <option value="baixa" {{ old('urgency_level', $vacancy->urgency_level) == 'baixa' ? 'selected' : '' }}>Baixa</option>
                                            <option value="media" {{ old('urgency_level', $vacancy->urgency_level) == 'media' ? 'selected' : '' }}>Média</option>
                                            <option value="alta" {{ old('urgency_level', $vacancy->urgency_level) == 'alta' ? 'selected' : '' }}>Alta</option>
                                            <option value="critica" {{ old('urgency_level', $vacancy->urgency_level) == 'critica' ? 'selected' : '' }}>Crítica</option>
                                        </select>
                                        @error('urgency_level')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="aberta" {{ old('status', $vacancy->status) == 'aberta' ? 'selected' : '' }}>Aberta</option>
                                            <option value="pausada" {{ old('status', $vacancy->status) == 'pausada' ? 'selected' : '' }}>Pausada</option>
                                            <option value="encerrada" {{ old('status', $vacancy->status) == 'encerrada' ? 'selected' : '' }}>Encerrada</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('department_id') is-invalid @enderror" 
                                            ...
                                            @foreach($departments as $department)
                                                <option value="{{ $department->department_id }}" {{ old('department_id', $vacancy->department_id) == $department->department_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="work_type" 
                                               name="work_type" 
                                               value="{{ old('work_type', $vacancy->work_type) }}" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="work_schedule" 
                                               name="work_schedule" 
                                               value="{{ old('work_schedule', $vacancy->work_schedule) }}" 
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('requirements') is-invalid @enderror" 
                                                  ...
                                                  name="requirements" 
                                                  rows="4" 
                                                  placeholder="Liste os requisitos necessários para a vaga...">{{ old('requirements', $vacancy->requirements) }}</textarea>
                                        @error('requirements')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('benefits') is-invalid @enderror" 
                                                  ...
                                                  name="benefits" 
                                                  rows="4" 
                                                  placeholder="Liste os benefícios oferecidos...">{{ old('benefits', $vacancy->benefits) }}</textarea>
                                        @error('benefits')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
