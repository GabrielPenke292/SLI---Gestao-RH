                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h4 class="mb-0"><i class="fas fa-user-edit me-2"></i>Editar Candidato</h4>
                            <a href="{{ route('candidates.show', $candidate->candidate_id) }}" class="btn btn-light btn-sm">
                ...
                <div class="col-12 mt-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <form action="{{ route('candidates.update', $candidate->candidate_id) }}" method="POST" enctype="multipart/form-data" id="candidateForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_phone') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_phone', $candidate->candidate_phone) }}" 
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_document') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_document', $candidate->candidate_document) }}" 
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('candidate_birth_date') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_birth_date', $candidate->candidate_birth_date?->format('Y-m-d')) }}">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_rg') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_rg', $candidate->candidate_rg) }}" 
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_address') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_address', $candidate->candidate_address) }}" 
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_zipcode') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_zipcode', $candidate->candidate_zipcode) }}" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_city') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_city', $candidate->candidate_city) }}" 
                                               placeholder="Cidade" 
                                               maxlength="100">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('candidate_state') is-invalid @enderror" 
                                               ...
                                               value="{{ old('candidate_state', $candidate->candidate_state) }}" 
                                               placeholder="SP" 
                                               maxlength="2">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('candidate_experience') is-invalid @enderror" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="Descreva a experiência profissional do candidato...">{{ old('candidate_experience', $candidate->candidate_experience) }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('candidate_education') is-invalid @enderror" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="Descreva a formação acadêmica do candidato...">{{ old('candidate_education', $candidate->candidate_education) }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('candidate_skills') is-invalid @enderror" 
                                                  ...
                                                  rows="3" 
                                                  placeholder="Liste as habilidades e competências do candidato...">{{ old('candidate_skills', $candidate->candidate_skills) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="file" 
                                               ...
                                               accept=".pdf">
                                        <small class="form-text text-muted">Tamanho máximo: 10MB. Apenas arquivos PDF. Deixe em branco para manter o arquivo atual.</small>
                                        @if($candidate->has_resume_pdf)
                                            <div class="mt-2">
                                                <a href="{{ $candidate->resume_pdf_url }}" target="_blank" class="btn btn-sm btn-outline-danger">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('candidate_resume_text') is-invalid @enderror" 
                                                  ...
                                                  rows="10" 
                                                  placeholder="Cole aqui todo o texto do currículo para permitir buscas mais eficientes...">{{ old('candidate_resume_text', $candidate->candidate_resume_text) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('candidate_notes') is-invalid @enderror" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="Adicione observações sobre o candidato...">{{ old('candidate_notes', $candidate->candidate_notes) }}</textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 d-flex justify-content-end gap-2">
                                        <a href="{{ route('candidates.show', $candidate->candidate_id) }}" class="btn btn-secondary">
                                            <i class="fas fa-times me-2"></i>Cancelar
                                        </a>
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Atualizar Candidato
                                        </button>
                                    </div>
                                </div>
                            </form>
