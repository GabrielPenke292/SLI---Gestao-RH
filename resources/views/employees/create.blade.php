                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Cadastrar Novo Funcionário</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('worker_status') is-invalid @enderror" 
                                                    ...
                                                    <option value="1" {{ old('worker_status') == '1' ? 'selected' : '' }}>Ativo</option>
                                                    <option value="0" {{ old('worker_status') == '0' ? 'selected' : '' }}>Inativo</option>
                                                </select>
                                                @error('worker_status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
