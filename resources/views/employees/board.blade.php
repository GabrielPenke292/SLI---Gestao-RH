...
<script>
    $(document).ready(function() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        html += '<button type="button" class="btn btn-info btn-view" data-id="' + row.id + '" title="Visualizar">';
                        html += '<i class="fas fa-eye"></i>';
                        html += '</button>';
                        html += '<button type="button" class="btn btn-warning btn-edit" data-id="' + row.id + '" title="Editar">';
        ...
        $(document).on('click', '.btn-view', function() {
            ...
            // Implementar modal ou redirecionamento para visualização
        });
